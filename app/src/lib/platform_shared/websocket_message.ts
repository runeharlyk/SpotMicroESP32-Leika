...
export interface CorrelationResponse {
  ...
  i2cScanData?: I2CScanData | undefined;
  imuCalibrateData?: IMUCalibrateData | undefined;
}
...
export const CorrelationRequest: MessageFns<CorrelationRequest> = {
  encode(message: CorrelationRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.i2cScanDataRequest !== undefined) {
      I2CScanDataRequest.encode(message.i2cScanDataRequest, writer.uint32(162).fork()).join();
    }
    if (message.imuCalibrateExecute !== undefined) {
      IMUCalibrateExecute.encode(message.imuCalibrateExecute, writer.uint32(242).fork()).join();
    }
    return writer;
  },
...
function createBaseCorrelationResponse(): CorrelationResponse {
  return {
    ...
    i2cScanData: undefined,
    imuCalibrateData: undefined,
  };
}
...
export const CorrelationResponse: MessageFns<CorrelationResponse> = {
  encode(message: CorrelationResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.i2cScanData !== undefined) {
      I2CScanData.encode(message.i2cScanData, writer.uint32(162).fork()).join();
    }
    if (message.imuCalibrateData !== undefined) {
      IMUCalibrateData.encode(message.imuCalibrateData, writer.uint32(242).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 20: {
          ...
          message.i2cScanData = I2CScanData.decode(reader, reader.uint32());
          continue;
        }
        case 30: {
          if (tag !== 242) {
          ...
          message.imuCalibrateData = IMUCalibrateData.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): CorrelationResponse {
    return {
      ...
      featuresDataResponse: isSet(object.featuresDataResponse)
        ...
        : undefined,
      i2cScanData: isSet(object.i2cScanData) ? I2CScanData.fromJSON(object.i2cScanData) : undefined,
      imuCalibrateData: isSet(object.imuCalibrateData) ? IMUCalibrateData.fromJSON(object.imuCalibrateData) : undefined,
    };
  },
  ...
  toJSON(message: CorrelationResponse): unknown {
    ...
    if (message.i2cScanData !== undefined) {
      obj.i2cScanData = I2CScanData.toJSON(message.i2cScanData);
    }
    if (message.imuCalibrateData !== undefined) {
      obj.imuCalibrateData = IMUCalibrateData.toJSON(message.imuCalibrateData);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CorrelationResponse>, I>>(object: I): CorrelationResponse {
    ...
    message.featuresDataResponse = (object.featuresDataResponse !== undefined && object.featuresDataResponse !== null)
      ...
      : undefined;
    message.i2cScanData = (object.i2cScanData !== undefined && object.i2cScanData !== null)
      ? I2CScanData.fromPartial(object.i2cScanData)
      : undefined;
    message.imuCalibrateData = (object.imuCalibrateData !== undefined && object.imuCalibrateData !== null)
      ? IMUCalibrateData.fromPartial(object.imuCalibrateData)
      : undefined;
    return message;
  },
};
