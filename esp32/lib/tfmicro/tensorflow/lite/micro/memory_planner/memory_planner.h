...
class MemoryPlanner {
  public:
    ...
    // GetOffsetForBuffer().
    virtual TfLiteStatus AddBuffer(tflite::ErrorReporter* error_reporter, int size, int first_time_used,
    ...
    virtual TfLiteStatus GetOffsetForBuffer(tflite::ErrorReporter* error_reporter, int buffer_index, int* offset) = 0;
};
