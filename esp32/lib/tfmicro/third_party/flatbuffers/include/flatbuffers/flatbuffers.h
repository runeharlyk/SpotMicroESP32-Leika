...
struct VectorReverseIterator : public std::reverse_iterator<Iterator> {
    ...
    typename Iterator::value_type operator*() const { return *(std::reverse_iterator<Iterator>::current); }
...
class FlatBufferBuilder {
  ...
  Offset<String> CreateString(flatbuffers::string_view str) {
    ...
    /// @return Returns the offset in the buffer where the string starts
    Offset<String> CreateString(const String *str) { return str ? CreateString(str->c_str(), str->size()) : 0; }
    ...
    /// @param[in] str A const pointer to a `String` struct to add to the buffer.
    /// @return Returns the offset in the buffer where the string starts
    Offset<String> CreateSharedString(const String *str) { return CreateSharedString(str->c_str(), str->size()); }
    ...
    void ForceStringAlignment(size_t len, size_t alignment) { PreAlign((len + 1) * sizeof(char), alignment); }
